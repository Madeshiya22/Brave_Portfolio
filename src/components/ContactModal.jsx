        ...
        {sent ? (
          ...
          <form ref={formRef} className="contact-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="contact-form__field">
              <label htmlFor="cm-name"><User size={14} /> Name</label>
              <input
            ...
            <div className="contact-form__field">
              <label htmlFor="cm-email"><Mail size={14} /> Email</label>
              <input
            ...
            <div className="contact-form__field">
              <label htmlFor="cm-message"><MessageSquare size={14} /> Message</label>
              <textarea
                id="cm-message" name="message"
